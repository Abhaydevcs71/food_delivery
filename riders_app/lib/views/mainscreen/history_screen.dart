...
class HistoryScreen extends StatefulWidget {
  ...
  @override
  State<HistoryScreen> createState() => _NewOrderScreenState();
}

class _NewOrderScreenState extends State<HistoryScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppBar(titleMsg: "My History", showBackButton: true),
      body: StreamBuilder<QuerySnapshot>(
        stream: orderViewModel.retieveHistoryOrders(),
