...
class InProgressScreen extends StatefulWidget {
  ...
  @override
  State<InProgressScreen> createState() => _NewOrderScreenState();
}

class _NewOrderScreenState extends State<InProgressScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppBar(titleMsg: "My Orders", showBackButton: true),
      body: StreamBuilder<QuerySnapshot>(
        stream: orderViewModel.retievePickedOrders(),
